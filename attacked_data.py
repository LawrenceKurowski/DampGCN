...
class PrePtbDataset:
    ...
    def __init__(self, root, name, attack_method='meta', seed=10,ptb_rate=0.05):
    ...
    def get_target_nodes(self):
        ...
        url = 'https://github.com/ChandlerBang/Pro-GNN/blob/master/nettack/{}_nettacked_nodes.json'.format(self.name)
